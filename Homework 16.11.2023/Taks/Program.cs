...
namespace Task
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Game> games = new List<Game>() { beach, fishing, hill, mousetrap, postmen, sea };
            ...
            Player Mikhail = new Player("Михаил", Countries.Россия);
            ...
            List<Player> Russians = new List<Player>() { Aleksandr, Anastasia, Anna, Victoria, Vladimir, Daria, Ekaterina, Ivan, Irina, Kirill,
                Konstantin, Marina, Mikhail, Nikolay, Tatiana };
            ...
            Olivier.AddGameToBigRace(brs, football);
